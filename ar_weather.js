...
function get_coordinates(){
    ...
    function get_weather(){
        $.ajax({
            url: `https://api.openweathermap.org/data/2.5/weather?lat=${coordinates.destination_lat}&lon=${coordinates.destination_lon}&appid=628cb1b1fa67c52334ea83a2cb8bcc3e`,
            type: "get",
